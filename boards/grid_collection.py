...
from utils.consts import STD_HEIGHT, STD_WIDTH, TELEPORT_POD_ENTITY
...
square_obstacle_grid.add_at(2, 4, OBSTACLE_CHAR)
...
square_obstacle_grid.add_at(10, 4, OBSTACLE_CHAR)
...
square_obstacle_grid_11.add_at(9, 8, OBSTACLE_CHAR)
...
square_obstacle_grid_12.add_at(3, 7, OBSTACLE_CHAR)
...
square_obstacle_grid_13.add_at(6, 9, OBSTACLE_CHAR)
square_obstacle_grid_13.add_at(9, 8, OBSTACLE_CHAR)
square_obstacle_grid_13.add_at(10, 7, OBSTACLE_CHAR)
...
square_obstacle_grid_14.add_at(7, 10, OBSTACLE_CHAR)
square_obstacle_grid_14.add_at(4, 9, OBSTACLE_CHAR)
...
square_obstacle_grid_15.add_at(3, 2, OBSTACLE_CHAR)
square_obstacle_grid_15.add_at(8, 9, OBSTACLE_CHAR)
...
square_obstacle_grid_16.add_at(3, 2, OBSTACLE_CHAR)
square_obstacle_grid_16.add_at(3, 9, OBSTACLE_CHAR)
...
square_obstacle_grid_20.add_at(9, 2, OBSTACLE_CHAR)
square_obstacle_grid_20.add_at(10, 1, OBSTACLE_CHAR)
square_obstacle_grid_20.add_at(4, 9, OBSTACLE_CHAR)

square_obstacle_grid_21: Board = Board(STD_WIDTH, STD_HEIGHT)
square_obstacle_grid_21.add_obstacles_horizontally(4, 1, 5, OBSTACLE_CHAR)
square_obstacle_grid_21.add_obstacles_horizontally(6, 3, 5, OBSTACLE_CHAR)
square_obstacle_grid_21.add_obstacles_horizontally(8, 5, 4, OBSTACLE_CHAR)
square_obstacle_grid_21.add_obstacles_horizontally(9, 1, 3, OBSTACLE_CHAR)
square_obstacle_grid_21.add_obstacles_vertically(1, 5, 3, OBSTACLE_CHAR)
square_obstacle_grid_21.add_obstacles_vertically(1, 8, 6, OBSTACLE_CHAR)
square_obstacle_grid_21.add_obstacles_vertically(8, 6, 3, OBSTACLE_CHAR)
square_obstacle_grid_21.add_at(1, 1, TELEPORT_POD_ENTITY)
square_obstacle_grid_21.add_at(9, 7, TELEPORT_POD_ENTITY)

square_obstacle_grid_22: Board = Board(STD_WIDTH, STD_HEIGHT)
square_obstacle_grid_22.add_obstacles_vertically(4, 4, 7, OBSTACLE_CHAR)
square_obstacle_grid_22.add_obstacles_vertically(1, 7, 5, OBSTACLE_CHAR)
square_obstacle_grid_22.add_obstacles_horizontally(7, 5, 5, OBSTACLE_CHAR)
square_obstacle_grid_22.add_obstacles_horizontally(9, 7, 4, OBSTACLE_CHAR)
square_obstacle_grid_22.add_at(1, 1, OBSTACLE_CHAR)
square_obstacle_grid_22.add_at(2, 2, OBSTACLE_CHAR)
square_obstacle_grid_22.add_at(3, 3, OBSTACLE_CHAR)
square_obstacle_grid_22.add_at(10, 1, TELEPORT_POD_ENTITY)
square_obstacle_grid_22.add_at(6, 5, TELEPORT_POD_ENTITY)

square_obstacle_grid_23: Board = Board(STD_WIDTH, STD_HEIGHT)
square_obstacle_grid_23.add_obstacles_horizontally(4, 1, 3, OBSTACLE_CHAR)
square_obstacle_grid_23.add_obstacles_horizontally(4, 7, 4, OBSTACLE_CHAR)
square_obstacle_grid_23.add_obstacles_horizontally(9, 8, 3, OBSTACLE_CHAR)
square_obstacle_grid_23.add_obstacles_horizontally(9, 1, 3, OBSTACLE_CHAR)
square_obstacle_grid_23.add_obstacles_horizontally(2, 1, 3, OBSTACLE_CHAR)
square_obstacle_grid_23.add_obstacles_vertically(5, 3, 3, OBSTACLE_CHAR)
square_obstacle_grid_23.add_obstacles_vertically(5, 7, 5, OBSTACLE_CHAR)
square_obstacle_grid_23.add_obstacles_vertically(1, 5, 5, OBSTACLE_CHAR)
square_obstacle_grid_23.add_obstacles_vertically(7, 5, 4, OBSTACLE_CHAR)
square_obstacle_grid_23.add_at(7, 2, OBSTACLE_CHAR)
square_obstacle_grid_23.add_at(5, 2, TELEPORT_POD_ENTITY)
square_obstacle_grid_23.add_at(5, 10, TELEPORT_POD_ENTITY)


square_obstacle_grid_24: Board = Board(STD_WIDTH, STD_HEIGHT)
square_obstacle_grid_24.add_obstacles_vertically(1, 7, 4, OBSTACLE_CHAR)
square_obstacle_grid_24.add_obstacles_vertically(7, 6, 4, OBSTACLE_CHAR)
square_obstacle_grid_24.add_obstacles_horizontally(4, 8, 3, OBSTACLE_CHAR)
square_obstacle_grid_24.add_obstacles_horizontally(8, 1, 4, OBSTACLE_CHAR)
square_obstacle_grid_24.add_obstacles_horizontally(9, 7, 3, OBSTACLE_CHAR)
square_obstacle_grid_24.add_obstacles_horizontally(3, 1, 5, OBSTACLE_CHAR)
square_obstacle_grid_24.add_obstacles_horizontally(5, 3, 3, OBSTACLE_CHAR)
square_obstacle_grid_24.add_obstacles_horizontally(6, 7, 3, OBSTACLE_CHAR)
square_obstacle_grid_24.add_at(1, 10, TELEPORT_POD_ENTITY)
square_obstacle_grid_24.add_at(9, 2, TELEPORT_POD_ENTITY)

square_obstacle_grid_25: Board = Board(STD_WIDTH, STD_HEIGHT)

square_obstacle_grid_25.add_obstacles_vertically(1, 3, 4, OBSTACLE_CHAR)
square_obstacle_grid_25.add_obstacles_vertically(1, 8, 4, OBSTACLE_CHAR)
square_obstacle_grid_25.add_obstacles_vertically(8, 3, 3, OBSTACLE_CHAR)
square_obstacle_grid_25.add_obstacles_vertically(8, 8, 2, OBSTACLE_CHAR)
square_obstacle_grid_25.add_obstacles_horizontally(4, 4, 4, OBSTACLE_CHAR)
square_obstacle_grid_25.add_obstacles_horizontally(8, 4, 4, OBSTACLE_CHAR)
square_obstacle_grid_25.add_obstacles_horizontally(6, 1, 4, OBSTACLE_CHAR)
square_obstacle_grid_25.add_obstacles_horizontally(6, 7, 4, OBSTACLE_CHAR)
